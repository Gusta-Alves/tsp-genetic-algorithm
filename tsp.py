...
while running:
    ...
    pygame.draw.rect(screen, (200,200,200), (start_x, y, sum(col_widths), row_height))  # fundo
    pygame.draw.rect(screen, (0,0,0), (start_x, y, sum(col_widths), row_height), 2)    # borda
